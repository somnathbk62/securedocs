...
export default function AdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Navigation is handled in the adminLogin function
      }
    } catch (error) {
              ...
              <div className="card auth-card">
                <div className="row g-0">
                    ...
                    <div className="card-body p-4 p-md-5">
                      ...
                      <div className="text-center mb-3">
                        <Link to="/" className="auth-link">
                          <i className="fas fa-user me-2"></i> Login as Student
                        </Link>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 d-none d-md-block">
                    <div
                      className="auth-illustration h-100 d-flex align-items-center justify-content-center p-4"
                      style={{ backgroundColor: "#181d38", opacity: 0.9 }}
                    >
                      <img
                        src="/img/admin-illustration.svg"
                        alt="Admin Login"
                        className="img-fluid"
                      />
                    </div>
